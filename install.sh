...
# apt -y update
# apt -y upgrade
apt -y install build-essential libgd2-xpm-dev libgeoip-dev libpcre3-dev libssl-dev curl libcurl3 libcurl3-dev libmcrypt-dev libxslt-dev libxml2-dev sendmail
...
# Install PHP
wget https://php.net/distributions/php-7.2.8.tar.xz
